...
const FFMPEG_PATH = process.env.FFMPEG_PATH || 'C:\\Users\\Guram\\OneDrive\\Desktop\\Targmna\\ffmpeg-8.0.1-essentials_build\\ffmpeg-8.0.1-essentials_build\\bin\\ffmpeg.exe';
const FFPROBE_PATH = process.env.FFPROBE_PATH || 'C:\\Users\\Guram\\OneDrive\\Desktop\\Targmna\\ffmpeg-8.0.1-essentials_build\\ffmpeg-8.0.1-essentials_build\\bin\\ffprobe.exe';
